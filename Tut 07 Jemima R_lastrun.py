...
expName = 'Tut 07 Jemima R'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\JEMIMA\\Documents\\L in Psych Psychopy\\Tut 07 Jemima R_lastrun.py',
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/JEMIMA/Documents/L in Psych Psychopy/Tut 07 Cond.xlsx'),
